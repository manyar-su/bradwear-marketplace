...
import { AIPicker, ColorPicker, FilePicker, CustomButton, Tab, LogoPositioner } from "../components"
                ...
                <>
                    <motion.div className="absolute z-10 top-5 left-5" {...fadeAnimation}>
                        <button
                            ...
                            className="rounded-full bg-white/88 px-4 py-2.5 text-sm font-bold text-black shadow-[0_18px_40px_rgba(15,23,42,0.12)] transition hover:-translate-y-0.5"
                        >
                            Kembali ke Home
                        </button>
                    </motion.div>
                    ...
                    {/* Logo Positioner Modal */}
                    {showLogoPositioner && (
                        <LogoPositioner onClose={() => setShowLogoPositioner(false)} />
                    )}
                </>
            )}
        </AnimatePresence>
