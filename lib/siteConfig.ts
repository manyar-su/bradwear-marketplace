...
export const ARTICLES: Article[] = [
  ...
  {
    slug: 'cara-menentukan-ukuran-seragam-karyawan',
    category: 'Ukuran',
    highlight: 'Data ukuran yang rapi mengurangi revisi, salah size, dan keterlambatan saat produksi massal.',
    highlights: ['Gunakan format ukuran yang sama untuk semua divisi.', 'Pisahkan data pria, wanita, lengan panjang, dan lengan pendek.', 'Validasi size chart sebelum deadline produksi dikunci.'],
    coverImage: ARTICLE_IMAGE_FALLBACKS.procurementDesk,
    coverAlt: 'Dokumen pengukuran untuk artikel cara menentukan ukuran seragam karyawan',
    readTime: '8 menit',
    author: 'Tim Editorial Bradwear',
    authorRole: 'Riset ukuran dan validasi order',
    publishedAt: '2026-08-02',
    updatedAt: '2026-08-02',
    title: 'Cara menentukan ukuran seragam karyawan agar order produksi lebih akurat',
    ...
    body: [
      ...
      'Untuk kemeja dinas dan seragam kerja custom, size chart sebaiknya dicek bersama sebelum produksi. User bisa membandingkan ukuran dada, panjang badan, panjang lengan, dan toleransi jahit agar pilihan S, M, L, XL, atau custom size tidak hanya berdasarkan kebiasaan memakai baju harian.',
      'Bradwear menyarankan pembagian data berdasarkan kelompok kebutuhan: pria, wanita, lengan panjang, lengan pendek, serta item tambahan seperti rompi, jaket, atau celana. Pembagian ini membantu tim produksi membaca batch dengan lebih cepat dan mengurangi risiko salah kombinasi.',
      'Jika order melibatkan banyak cabang atau banyak divisi, batas waktu pengumpulan ukuran perlu dibuat jelas. Data yang masuk setelah approval akhir biasanya memengaruhi jadwal cutting, sehingga perubahan kecil dapat menggeser timeline produksi secara keseluruhan.',
      'Ukuran yang akurat tidak hanya membuat seragam lebih nyaman dipakai, tetapi juga membantu hasil akhir terlihat seragam saat dipakai satu tim. Dengan data yang rapi sejak awal, proses konsultasi, mockup, dan produksi bisa berjalan lebih tenang.',
    ],
    comments: [
      {
        id: 'comment-size-1',
        author: 'Ari Wibowo',
        role: 'Admin HR perusahaan jasa',
        publishedAt: '2026-08-02',
        body: 'Bagian format ukuran membantu karena selama ini data size kami sering masuk dari beberapa grup berbeda.',
      },
      {
        id: 'comment-size-2',
        author: 'Putri Lestari',
        role: 'PIC seragam sekolah',
        publishedAt: '2026-08-02',
        body: 'Poin memisahkan data pria, wanita, dan lengan sangat relevan untuk menghindari salah input saat order kemeja dinas.',
      },
    ],
  },
  {
    slug: 'bahan-seragam-lapangan-ripstop-drill-dan-tropical',
    category: 'Bahan Lapangan',
    highlight: 'Bahan lapangan harus dipilih dari aktivitas kerja, bukan dari nama kain yang terdengar paling kuat.',
    highlights: ['Ripstop cocok untuk kebutuhan yang butuh ketahanan gesek lebih tinggi.', 'Drill memberi struktur rapi untuk seragam operasional harian.', 'Tropical lebih ringan untuk kebutuhan formal yang tidak terlalu berat.'],
    coverImage: ARTICLE_IMAGE_FALLBACKS.fabric,
    coverAlt: 'Kain seragam untuk artikel bahan seragam lapangan Ripstop Drill dan Tropical',
    readTime: '8 menit',
    author: 'Tim Editorial Bradwear',
    authorRole: 'Riset bahan lapangan',
    publishedAt: '2026-08-02',
    updatedAt: '2026-08-02',
    ...
    body: [
      ...
      'Drill menjadi pilihan yang lebih seimbang untuk banyak seragam kerja karena tampil rapi, punya struktur cukup tegas, dan tetap fleksibel untuk kebutuhan kantor maupun lapangan ringan. Pada kemeja dinas, jenis drill tertentu sering dipilih ketika user ingin kesan formal tetapi tidak terlalu tipis.',
      'Tropical cenderung lebih ringan dan cocok untuk seragam yang lebih formal atau aktivitas dengan mobilitas sedang. Bahan ini membantu tampilan tetap rapi tanpa membuat seragam terasa terlalu berat saat dipakai harian.',
      'Bradwear biasanya membantu user membandingkan bahan dari tiga pertanyaan: seragam dipakai di dalam atau luar ruangan, seberapa sering dicuci, dan apakah pemakai membutuhkan gerak aktif. Jawaban dari tiga hal itu akan mempersempit pilihan bahan dengan lebih objektif.',
      'Saat bahan sudah sesuai fungsi, proses desain juga lebih mudah dikunci. Warna, bordir logo, posisi atribut, dan model kantong dapat disesuaikan dengan karakter kain sehingga hasil akhir terlihat rapi sekaligus relevan untuk pemakaian nyata.',
    ],
    comments: [
      {
        id: 'comment-field-fabric-1',
        author: 'Deden Permana',
        role: 'Koordinator operasional lapangan',
        publishedAt: '2026-08-02',
        body: 'Penjelasan Ripstop dan Drill membantu saat kami membedakan kebutuhan tim lapangan dan admin kantor.',
      },
      {
        id: 'comment-field-fabric-2',
        author: 'Maya Kartika',
        role: 'Procurement perusahaan distribusi',
        publishedAt: '2026-08-02',
        body: 'Artikel ini membuat diskusi bahan lebih jelas karena fokusnya pada aktivitas kerja, bukan hanya nama kain.',
      },
    ],
  },
  {
    slug: 'lead-time-produksi-seragam-custom',
    category: 'Timeline Produksi',
    highlight: 'Lead time produksi lebih mudah dijaga ketika brief, ukuran, logo, dan approval final masuk sesuai urutan.',
    highlights: ['Timeline normal dipengaruhi volume, revisi, bahan, dan antrean produksi.', 'Approval desain yang lambat akan menggeser jadwal cutting dan jahit.', 'Order mendesak perlu brief yang lebih ringkas dan keputusan yang lebih cepat.'],
    coverImage: ARTICLE_IMAGE_FALLBACKS.productionFloor,
    coverAlt: 'Area produksi untuk artikel lead time produksi seragam custom',
    readTime: '7 menit',
    author: 'Tim Editorial Bradwear',
    authorRole: 'Workflow produksi',
    publishedAt: '2026-08-02',
    updatedAt: '2026-08-02',
    ...
    body: [
      ...
      'Sebaliknya, revisi yang terus berubah biasanya menjadi penyebab timeline bergeser. Perubahan warna, penambahan nama personel, revisi posisi bordir, atau data ukuran yang terlambat masuk dapat memengaruhi jadwal cutting dan antrean jahit.',
      'Ketersediaan bahan juga perlu dihitung secara realistis. Untuk warna atau material tertentu, vendor mungkin perlu memastikan stok lebih dulu sebelum mengunci jadwal. Semakin spesifik kebutuhan kain, semakin penting validasi bahan dilakukan di awal.',
      'Bradwear membantu pelanggan membaca timeline dari kondisi order yang sebenarnya. Jika kebutuhan mendesak, tim akan menyarankan pilihan model, bahan, dan detail custom yang lebih cepat diproses tanpa mengorbankan kerapian hasil akhir.',
      'Cara terbaik menjaga lead time adalah membuat keputusan berurutan: finalkan model, finalkan bahan dan warna, kunci data ukuran, setujui layout logo, lalu baru masuk produksi. Urutan ini membuat komunikasi lebih rapi dan risiko revisi mendadak lebih kecil.',
    ],
    comments: [
      {
        id: 'comment-leadtime-1',
        author: 'Hendra Saputra',
        role: 'PIC event perusahaan',
        publishedAt: '2026-08-02',
        body: 'Poin approval desain sangat sesuai dengan pengalaman kami. Produksi sering mundur karena revisi internal belum selesai.',
      },
      {
        id: 'comment-leadtime-2',
        author: 'Vina Rahmadani',
        role: 'Admin pengadaan komunitas',
        publishedAt: '2026-08-02',
        body: 'Artikel ini membantu menjelaskan ke anggota tim kenapa data ukuran harus masuk sebelum deadline dikunci.',
      },
    ],
  },
  {
    slug: 'bordir-nama-personel-dan-jabatan-seragam-kerja',
    category: 'Bordir',
    highlight: 'Bordir nama dan jabatan perlu standar penulisan agar hasil seragam terlihat konsisten dalam satu batch.',
    highlights: ['Kunci format nama, jabatan, dan divisi sebelum produksi.', 'Cek ulang ejaan karena bordir sulit diperbaiki setelah jadi.', 'Sesuaikan ukuran teks dengan area dada atau lengan.'],
    coverImage: ARTICLE_IMAGE_FALLBACKS.formalUniform,
    coverAlt: 'Seragam formal untuk artikel bordir nama personel dan jabatan',
    readTime: '7 menit',
    author: 'Tim Editorial Bradwear',
    authorRole: 'Riset bordir dan identitas seragam',
    publishedAt: '2026-08-02',
    updatedAt: '2026-08-02',
    ...
    body: [
      ...
      'Ejaan menjadi bagian paling penting karena bordir sulit diperbaiki setelah masuk produksi. Kesalahan satu huruf pada nama, gelar, atau jabatan dapat membuat item harus dikerjakan ulang, terutama pada kemeja dinas atau seragam formal yang dipakai di depan publik.',
      'Ukuran teks juga perlu disesuaikan dengan area bordir. Nama yang terlalu panjang mungkin perlu ukuran huruf lebih kecil atau susunan dua baris agar tetap terbaca tanpa membuat area dada terlihat penuh.',
      'Bradwear biasanya menyarankan user menyamakan pola penulisan, misalnya apakah jabatan ditulis lengkap atau disingkat, apakah gelar dicantumkan, dan apakah nama divisi ditempatkan bersama nama atau dipisah pada area lain.',
      'Ketika format bordir sudah final, hasil seragam terlihat lebih profesional karena setiap orang memakai identitas dengan standar visual yang sama. Ini penting untuk instansi, perusahaan, sekolah, dan komunitas yang ingin tampil rapi di lapangan maupun acara resmi.',
    ],
    comments: [
      {
        id: 'comment-name-embroidery-1',
        author: 'Nanda Prasetyo',
        role: 'Sekretariat instansi',
        publishedAt: '2026-08-02',
        body: 'Bagian ejaan sangat penting karena nama personel memang paling rawan salah kalau data tidak dicek dari awal.',
      },
      {
        id: 'comment-name-embroidery-2',
        author: 'Intan Maharani',
        role: 'HR perusahaan cabang',
        publishedAt: '2026-08-02',
        body: 'Panduan format tabel bordir membantu kami menyusun data jabatan dan divisi sebelum masuk produksi.',
      },
    ],
  },
  {
    slug: 'vendor-seragam-custom-seluruh-indonesia',
    category: 'Vendor Nasional',
    highlight: 'Vendor seragam nasional harus kuat di komunikasi, spesifikasi, produksi, dan pengiriman lintas daerah.',
    highlights: ['Cek cara vendor merangkum brief dan revisi.', 'Pastikan katalog, bahan, dan kontak konsultasi mudah diakses online.', 'Pengiriman lintas daerah perlu data alamat dan PIC penerima yang rapi.'],
    coverImage: ARTICLE_IMAGE_FALLBACKS.garmentRack,
    coverAlt: 'Rak seragam untuk artikel vendor seragam custom seluruh Indonesia',
    readTime: '8 menit',
    author: 'Tim Editorial Bradwear',
    authorRole: 'Riset vendor nasional',
    publishedAt: '2026-08-02',
    updatedAt: '2026-08-02',
    title: 'Vendor seragam custom seluruh Indonesia: cara menilai layanan sebelum order',
    ...
    body: [
      ...
      'Hal kedua adalah kualitas komunikasi. Vendor yang baik akan merangkum brief menjadi data yang mudah disetujui: model, bahan, warna, ukuran, logo, nama, jumlah item, timeline, dan alamat pengiriman. Ringkasan ini membuat order lintas daerah tetap terkontrol.',
      'Hal ketiga adalah kesiapan produksi dan pengiriman. Untuk order dari luar kota, data alamat, PIC penerima, opsi kurir, dan nomor resi harus jelas agar pelanggan bisa memantau barang setelah produksi selesai.',
      'Bradwear berbasis di Tasikmalaya, tetapi alur konsultasi digital dibuat agar pelanggan dari berbagai daerah tetap bisa memesan seragam custom dengan proses yang ringkas. Website menyediakan katalog, artikel, cara order, pelacakan, dan kontak layanan pelanggan dalam satu alur.',
      'Memilih vendor nasional bukan berarti memilih yang paling besar, tetapi yang paling mampu menjaga detail. Jika komunikasi, spesifikasi, produksi, dan pengiriman tertata, proyek seragam custom lintas daerah dapat berjalan lebih efisien dan hasilnya tetap konsisten.',
    ],
    comments: [
      {
        id: 'comment-national-vendor-1',
        author: 'Raka Firmansyah',
        role: 'PIC cabang perusahaan nasional',
        publishedAt: '2026-08-02',
        body: 'Artikel ini relevan untuk tim luar kota karena kami memang butuh vendor yang bisa merangkum spesifikasi secara online.',
      },
      {
        id: 'comment-national-vendor-2',
        author: 'Sella Kartini',
        role: 'Koordinator komunitas daerah',
        publishedAt: '2026-08-02',
        body: 'Bagian pengiriman dan PIC penerima membantu karena order komunitas kami biasanya dikirim ke beberapa alamat.',
      },
    ],
  },
];
...
export const BASE_KEYWORDS = [
  ...
  'bahan seragam lapangan terbaik',
